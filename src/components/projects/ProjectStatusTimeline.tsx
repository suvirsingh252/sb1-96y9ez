...
const STATUS_LABELS = {
  ...
  [ParticipantStatus.BOOKED]: 'Audit Scheduled',
  [ParticipantStatus.AUDIT_COMPLETED]: 'Initial Audit Completed',
  [ParticipantStatus.READY_FOR_TECH_TEAM]: 'Ready for Technical Review',
  ...
  [ParticipantStatus.FINAL_AUDIT_BOOKED]: 'Final Audit Scheduled',
